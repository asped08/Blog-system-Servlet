    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String titleName = request.getParameter("topic");
         ...
         System.out.println(Paths.get(".").toAbsolutePath());
          File folder = new File("../webapps/ProjectBlog/Documents");
            if(folder.exists()){
            noOfPost = folder.listFiles().length;
            count = noOfPost;
            }else{
            new File("../webapps/ProjectBlog/Documents").mkdirs();
       ...
       JSONObject obj = new JSONObject();
        ...
        obj.put("Comments List", comments);
         ...
         file = new FileWriter("../webapps/ProjectBlog/Documents/post"+count+".txt");
        try {
